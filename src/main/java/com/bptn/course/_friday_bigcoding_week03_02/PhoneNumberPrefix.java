package com.bptn.course._friday_bigcoding_week03_02;
...
public class PhoneNumberPrefix {
    ...
    List<String> phoneNumbers = new ArrayList<>();
        ...
        for (String phoneNumber : phoneNumbers) {
            String prefix = phoneNumber.substring(0, 7); // Extract the first seven characters
            prefixes.add(prefix); // Add to the set
        }
